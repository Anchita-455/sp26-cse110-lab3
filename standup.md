...
| Lucy  | created histograms | model using SVM  | need to log transform due to skewness |
| Peter  | created boxplots  | plot learning curve  | redo boxplots after log transform |
...
| Lucy  | created histograms | model using SVM  | |
| Peter  | created boxplots  | plot learning curve  | |
| Edmund  | selected dataset  | do hyperparameter tuning  | |
...
| Lucy  |  | SVM modeling in progress| |
| Peter  |  | Assisting Aslan with KNN modeling | |
...
| Lucy  | SVM modeling complete | assisting Peter with learning curve| |
